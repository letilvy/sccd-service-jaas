            ...
            switch(sEntitySet){
                ...
                case "UTSet":
                    ...
                    if(!oUrlParam.pid){
                        ...
                        sQuery = "select ut.tcid tcid, ut.pid projectId, p.name projectName, p.team teamId, t.name teamName, ut.passed passed, ut.failed failed, ut.assertion assertion, ut.skipped, ut.inclstmtlines includeLine, ut.inclstmtcover includeCover, round(ut.inclstmtlines * ut.inclstmtcover) incluCoverLine, ut.allstmtlines allLine, ut.allstmtcover allCover, round(ut.allstmtlines * ut.allstmtcover) allCoverLine, ut.timestamp timestamp from (select t.pid, substring_index(group_concat(t.tcid), ',', -1) last_commit_id from (select u.tcid, u.pid, u.timestamp from UT u where timestamp > 0 and branch = 'master' order by u.pid asc, timestamp desc) t group by t.pid) l left join UT ut on l.last_commit_id = ut.tcid left join Project p on ut.pid = p.pid left join Team t on p.team = t.tid order by p.team desc, ut.assertion desc";
                    }else{
